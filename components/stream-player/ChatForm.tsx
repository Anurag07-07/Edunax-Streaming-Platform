...
onSubmit,value,onChange,isHidden,isFollowersOnly,isFollowing,isDelayed
}:ChatFormProps) => {
  ...
  return (
    <form className=' flex flex-col gap-y-4 p-3 ' onSubmit={handleSubmit}>
      <div className=' w-full'>
      <ChatInfo
       isDelayed={isDelayed}
       isFollowerOnly={isFollowersOnly}
      ></ChatInfo>
      <Input
